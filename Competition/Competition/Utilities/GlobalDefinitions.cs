...
namespace Competition.Utilities
{
    public class GlobalDefinitions
    {
       ...
       #region screenshots
        ...
        {
            public static string SaveScreenshot(IWebDriver driver, string ScreenShots) // Definition
            {
                ...
                var fileName = new StringBuilder(CommonDriver.ScreenshotPath + ScreenShots + DateTime.Now.ToString("_dd-MM-yyyy_HHmm") + ".jpeg");
